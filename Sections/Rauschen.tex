...
\begin{minipage}[t]{0.4\textwidth}
	\vspace{0pt}
	\includegraphics[width=\textwidth]{"WiderstandSerielParallel"}
\end{minipage}\hspace{0.05\textwidth}
\begin{minipage}[t]{0.55\textwidth}
	\vspace{0pt}
	Äquivaltente Schaltung von Spannungsteiler. Quellenumwandlung und dann Erstazwiderstand gesehen vom Ausgang.
	\formula{$\overline{v^2_{T_n}} = 4 k T R_T B = 4 k T (R_2 + R_1\parallel R_3) B$}\\
	\unitText{$\overline{v^2_{T_n}}$}{Rauschleistung von $R_1$, $R_2$ und $R_3$}
\end{minipage}\hspace{0.05\textwidth}
\vspace{2mm}
%--------------------------------------------------------------------------------
...
\end{minipage}\hspace{0.05\textwidth}
\begin{minipage}[t]{0.3\textwidth}
	\unitText{$f_c \text{,} \mathit{BW}$}{Systembandbreite (3dB)}\\
