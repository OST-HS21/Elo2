...
\begin{minipage}[t]{0.3\textwidth}
	...
	\includegraphics[width=\textwidth]{"Spannungsteiler_Graph"}
\end{minipage}
\vspace{2mm}
...
\begin{minipage}[t]{0.3\textwidth}
	\vspace{0pt}								% Abbildung hier einfügen
	\includegraphics[width=\textwidth]{"Diodenreferenz"}
\end{minipage}\hspace{0.05\textwidth}
\begin{minipage}[t]{0.3\textwidth}
	\vspace{0pt}
...
\begin{minipage}[t]{0.3\textwidth}
	...
	\includegraphics[width=\textwidth]{"Diodenreferenz_Graph"}
\end{minipage}
\vspace{2mm}
...
\subsubsection{Spannungsstabilisierung mit Zenerdiode und Bipolar-Transistor}
\begin{minipage}[t]{0.3\textwidth}
	\vspace{0pt}								% Abbildung hier einfügen
...
\subsubsection{Einstellbare Seriespannungsquelle}
\begin{minipage}[t]{0.3\textwidth}
	\vspace{0pt}								% Abbildung hier einfügen
...
\begin{minipage}[t]{0.65\textwidth}
	\vspace{0pt}								% Beschreibung und Formeln hier einfügen
	\formula{$V_{out} = V_{ref} \cdot \left(1 + \dfrac{R_2}{R_1}\right) + I_{adj} \cdot (R_1 + R_2)$}
\end{minipage}
\vspace{2mm}